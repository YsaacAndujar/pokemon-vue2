...
.pkm-type {
  ...
  &.fire       { background-color: #e2382f; border-top-color: lighten(#e2382f,15%); border-bottom-color: darken(#e2382f,15%); }
  &.fighting   { background-color: #ad2a23; border-top-color: lighten(#ad2a23,15%); border-bottom-color: darken(#ad2a23,15%); }
  ...
  &.flying     { background-color: #5bb9e9; border-top-color: lighten(#5bb9e9,15%); border-bottom-color: darken(#5bb9e9,15%); }
